 ...
 */
export function sniffFormat(content, filePath) {
    if (filePath) {
 ...
 */
export async function translateSnapshot(content, format) {
    let parsed;
    switch (format) {
        case 'json':
            try {
 ...
 */
export function stripImplementation(content) {
