...
export declare function buildFlatTree(root: TreeNode, expanded: Set<string>): FlatTreeItem[];
export declare function SnapshotBrowser({ tree, files, onExit }: SnapshotBrowserProps): React.FunctionComponentElement<{
