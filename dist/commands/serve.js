...
export class ServeCommand extends Command {
    ...
    async execute(args, options, context) {
        try {
                ...
                switch (request.params.name) {
                    ...
                    case 'search': {
                        ...
                        try {
                            ...
                            throw new McpError(ErrorCode.InvalidParams, `Invalid regex: ${err.message}`);
                        }
                        return {
                            content: [
                                {
                    ...
                    case 'jq_query': {
                        ...
                        try {
                            ...
                            throw new McpError(ErrorCode.InvalidParams, `jq error: ${err.message}`);
                        }
                    }
                    case 'summarize': {
            ...
            return this.error(`Serve failed: ${err.message}`, options);
        }
    }
    parseArgs(args) {
        let snapshotFile;
