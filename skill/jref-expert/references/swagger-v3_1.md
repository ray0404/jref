- [Get started](https://swagger.io/tools/swaggerhub/why-swaggerhub)
...
An OpenAPI Description (OAD) formally describes the surface of an API and its semantics. It is composed of an [entry document](https://swagger.io/specification/#openapi-description-structure), which must be an OpenAPI Document, and any/all of its referenced documents. An OAD uses and conforms to the OpenAPI Specification, and MUST contain at least one [paths](https://swagger.io/specification/#paths-object) field, [components](https://swagger.io/specification/#oas-components) field, or [webhooks](https://swagger.io/specification/#oas-webhooks) field.

### OpenAPI Document

An OpenAPI Document is a single JSON or YAML document that conforms to the OpenAPI Specification. An OpenAPI Document compatible with OAS 3.\*.\* contains a required [`openapi`](https://swagger.io/specification/#oas-version) field which designates the version of the OAS that it uses.

### Schema

A "schema" is a formal description of syntax and structure.
This document serves as the [schema](https://swagger.io/specification/#schema) for the OpenAPI Specification format; a non-authoritative JSON Schema based on this document is also provided on [spec.openapis.org](https://spec.openapis.org/) for informational purposes.
This specification also _uses_ schemas in the form of the [Schema Object](https://swagger.io/specification/#schema-object).
...
The [schema](https://swagger.io/specification/#schema) exposes two types of fields: _fixed fields_, which have a declared name, and _patterned fields_, which have a declared pattern for the field name.
...
An OpenAPI Description (OAD) MAY be made up of a single JSON or YAML document or be divided into multiple, connected parts at the discretion of the author. In the latter case, [Reference Object](https://swagger.io/specification/#reference-object), [Path Item Object](https://swagger.io/specification/#path-item-object) and [Schema Object](https://swagger.io/specification/#schema-object)`$ref` fields, as well as the [Link Object](https://swagger.io/specification/#link-object)`operationRef` field, and the URI form of the [Discriminator Object](https://swagger.io/specification/#discriminator-object)`mapping` field, are used to identify the referenced elements.
...
JSON or YAML objects within an OAD are interpreted as specific Objects (such as [Operation Objects](https://swagger.io/specification/#operation-object), [Response Objects](https://swagger.io/specification/#response-object), [Reference Objects](https://swagger.io/specification/#reference-object), etc.) based on their context. Depending on how references are arranged, a given JSON or YAML object can be interpreted in multiple different contexts:

- As the root object of the [entry document](https://swagger.io/specification/#openapi-description-structure), which is always interpreted as an OpenAPI Object
...
| --- | --- | --- |
| [Security Requirement Object](https://swagger.io/specification/#security-requirement-object)`{name}` | [Security Scheme Object](https://swagger.io/specification/#security-scheme-object) name under the [Components Object](https://swagger.io/specification/#components-object) | _n/a_ |
| [Discriminator Object](https://swagger.io/specification/#discriminator-object)`mapping` _(implicit, or explicit name syntax)_ | [Schema Object](https://swagger.io/specification/#schema-object) name under the Components Object | `mapping` _(explicit URI syntax)_ |
| [Operation Object](https://swagger.io/specification/#operation-object)`tags` | [Tag Object](https://swagger.io/specification/#tag-object)`name` (in the [OpenAPI Object](https://swagger.io/specification/#openapi-object)'s `tags` array) | _n/a_ |
| [Link Object](https://swagger.io/specification/#link-object)`operationId` | [Path Item Object](https://swagger.io/specification/#path-item-object)`operationId` | `operationRef` |

A fifth implicit connection involves appending the templated URL paths of the [Paths Object](https://swagger.io/specification/#paths-object) to the appropriate [Server Object](https://swagger.io/specification/#server-object)'s `url` field.
...
See [Appendix F: Resolving Security Requirements in a Referenced Document](https://swagger.io/specification/#appendix-f-resolving-security-requirements-in-a-referenced-document) for an example of the possible resolutions, including which one is recommended by this section.
...
Note that no aspect of implicit connection resolution changes how [URIs are resolved](https://swagger.io/specification/#relative-references-in-api-description-uris), or restricts their possible targets.
...
Models are defined using the [Schema Object](https://swagger.io/specification/#schema-object), which is a superset of the JSON Schema Specification Draft 2020-12.
...
As noted under [Data Type](https://swagger.io/specification/#data-types), both `type: number` and `type: integer` are considered to be numbers in the data model.
...
- as the key for a [MediaType Object](https://swagger.io/specification/#media-type-object)
- in the `contentType` field of an [Encoding Object](https://swagger.io/specification/#encoding-object)

If the [Schema Object](https://swagger.io/specification/#schema-object) will be processed by a non-OAS-aware JSON Schema implementation, it may be useful to include `contentMediaType` even if it is redundant. However, if `contentMediaType` contradicts a relevant Media Type Object or Encoding Object, then `contentMediaType` SHALL be ignored.
...
| --- | --- | --- |
| `type: string`<br>`format: binary` | `contentMediaType: image/png` | if redundant, can be omitted, often resulting in an empty [Schema Object](https://swagger.io/specification/#schema-object) |
...
As noted under [Parsing Documents](https://swagger.io/specification/#parsing-documents), this specification inherits JSON Schema Specification Draft 2020-12's requirements for [loading documents](https://datatracker.ietf.org/doc/html/draft-bhutton-json-schema-00#section-9) and associating them with their expected URIs, which might not match their current location.
...
Relative references in [Schema Objects](https://swagger.io/specification/#schema-object), including any that appear as `$id` values, use the nearest parent `$id` as a Base URI, as described by [JSON Schema Specification Draft 2020-12](https://tools.ietf.org/html/draft-bhutton-json-schema-00#section-8.2).
...
Unless specified otherwise, relative references are resolved using the URLs defined in the [Server Object](https://swagger.io/specification/#server-object) as a Base URL. Note that these themselves MAY be relative to the referring document.
...
| version | `string` | **REQUIRED**. The version of the OpenAPI Document (which is distinct from the [OpenAPI Specification version](https://swagger.io/specification/#oas-version) or the version of the API being described or the version of the OpenAPI Description). |
...
| default | `string` | **REQUIRED**. The default value to use for substitution, which SHALL be sent if an alternate value is _not_ supplied. If the [`enum`](https://swagger.io/specification/#server-variable-enum) is defined, the value MUST exist in the enum's values. Note that this behavior is different from the [Schema Object](https://swagger.io/specification/#schema-object)'s `default` keyword, which documents the receiver's behavior rather than inserting the value into the data. |
...
| pathItems | Map\[`string`, [Path Item Object](https://swagger.io/specification/#path-item-object)\] | An object to hold reusable [Path Item Objects](https://swagger.io/specification/#path-item-object). |
...
The path is appended to the URL from the [Server Object](https://swagger.io/specification/#server-object) in order to construct the full URL. The Paths Object MAY be empty, due to [Access Control List (ACL) constraints](https://swagger.io/specification/#security-filtering).
...
For simpler scenarios, a [`schema`](https://swagger.io/specification/#parameter-schema) and [`style`](https://swagger.io/specification/#parameter-style) can describe the structure and syntax of the parameter.
...
Serializing with `schema` is NOT RECOMMENDED for `in: "cookie"` parameters, `in: "header"` parameters that use HTTP header parameters (name=value pairs following a `;`) in their values, or `in: "header"` parameters where values might have non-URL-safe characters; see [Appendix D](https://swagger.io/specification/#appendix-d-serializing-headers-and-cookies) for details.
...
| examples | Map\[ `string`, [Example Object](https://swagger.io/specification/#example-object) \| [Reference Object](https://swagger.io/specification/#reference-object)\] | Examples of the parameter's potential value; see [Working With Examples](https://swagger.io/specification/#working-with-examples). |

See also [Appendix C: Using RFC6570-Based Serialization](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization) for additional guidance.

###### Fixed Fields for use with `content`

For more complex scenarios, the [`content`](https://swagger.io/specification/#parameter-content) field can define the media type and schema of the parameter, as well as give examples of its use.
...
See [Appendix E](https://swagger.io/specification/#appendix-e-percent-encoding-and-form-media-types) for a discussion of percent-encoding, including when delimiters need to be percent-encoded and options for handling collisions with percent-encoded data.
...
- For `form` and the non-RFC6570 query string styles `spaceDelimited`, `pipeDelimited`, and `deepObject`, each example is shown prefixed with `?` as if it were the only query parameter; see [Appendix C](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization) for more information on constructing query strings from multiple parameters, and [Appendix D](https://swagger.io/specification/#appendix-d-serializing-headers-and-cookies) for warnings regarding `form` and cookie parameters
- Note that the `?` prefix is not appropriate for serializing `application/x-www-form-urlencoded` HTTP message bodies, and MUST be stripped or (if constructing the string manually) not added when used in that context; see the [Encoding Object](https://swagger.io/specification/#encoding-object) for more information
- The examples are percent-encoded as required by RFC6570 and RFC3986; see [Appendix E](https://swagger.io/specification/#appendix-e-percent-encoding-and-form-media-types) for a thorough discussion of percent-encoding concerns, including why unencoded `|` (`%7C`), `[` (`%5B`), and `]` (`%5D`) seem to work in some environments despite not being compliant.

| [`style`](https://swagger.io/specification/#style-values) | `explode` | `undefined` | `string` | `array` | `object` |
| --- | --- | --- | --- | --- | --- |
...
The `example` and `examples` fields are mutually exclusive, and if either is present it SHALL _override_ any `example` in the schema.
See [Working With Examples](https://swagger.io/specification/#working-with-examples) for further guidance regarding the different ways of specifying examples, including non-JSON/YAML values.

##### Fixed Fields

| Field Name | Type | Description |
| --- | --- | --- |
| schema | [Schema Object](https://swagger.io/specification/#schema-object) | The schema defining the content of the request, response, parameter, or header. |
| example | Any | Example of the media type; see [Working With Examples](https://swagger.io/specification/#working-with-examples). |
| examples | Map\[ `string`, [Example Object](https://swagger.io/specification/#example-object) \| [Reference Object](https://swagger.io/specification/#reference-object)\] | Examples of the media type; see [Working With Examples](https://swagger.io/specification/#working-with-examples). |
| encoding | Map\[`string`, [Encoding Object](https://swagger.io/specification/#encoding-object)\] | A map between a property name and its encoding information. The key, being the property name, MUST exist in the schema as a property. The `encoding` field SHALL only apply to [Request Body Objects](https://swagger.io/specification/#request-body-object), and only when the media type is `multipart` or `application/x-www-form-urlencoded`. If no Encoding Object is provided for a property, the behavior is determined by the default values documented for the Encoding Object. |
...
In contrast to OAS 3.0, the `format` keyword has no effect on the content-encoding of the schema in OAS 3.1. Instead, JSON Schema's `contentEncoding` and `contentMediaType` keywords are used. See [Working With Binary Data](https://swagger.io/specification/#working-with-binary-data) for how to model various scenarios with these keywords, and how to migrate from the previous `format` usage.
...
To upload multiple files, a `multipart` media type MUST be used as shown under [Example: Multipart Form with Multiple Files](https://swagger.io/specification/#example-multipart-form-with-multiple-files).

##### Support for x-www-form-urlencoded Request Bodies

See [Encoding the `x-www-form-urlencoded` Media Type](https://swagger.io/specification/#encoding-the-x-www-form-urlencoded-media-type) for guidance and examples, both with and without the `encoding` field.

##### Special Considerations for `multipart` Content

See [Encoding `multipart` Media Types](https://swagger.io/specification/#encoding-multipart-media-types) for further guidance and examples, both with and without the `encoding` field.
...
| --- | --- | --- |
| [_absent_](https://swagger.io/specification/#working-with-binary-data) | _n/a_ | `application/octet-stream` |
...
To submit content using form url encoding via [RFC1866](https://tools.ietf.org/html/rfc1866), use the `application/x-www-form-urlencoded` media type in the [Media Type Object](https://swagger.io/specification/#media-type-object) under the [Request Body Object](https://swagger.io/specification/#request-body-object).
...
When there is no [`encoding`](https://swagger.io/specification/#media-type-encoding) field, the serialization strategy is based on the Encoding Object's default values:
...
Note that the `id` keyword is treated as `text/plain` per the [Encoding Object](https://swagger.io/specification/#encoding-object)'s default behavior, and is serialized as-is.
...
+Using `contentEncoding` for a multipart field is equivalent to specifying an [Encoding Object](https://swagger.io/specification/#encoding-object) with a `headers` field containing `Content-Transfer-Encoding` with a schema that requires the value used in `contentEncoding`.
...
Note that as stated in [Working with Binary Data](https://swagger.io/specification/#working-with-binary-data), if the Encoding Object's `contentType`, whether set explicitly or implicitly through its default value rules, disagrees with the `contentMediaType` in a Schema Object, the `contentMediaType` SHALL be ignored.
...
As seen in the [Encoding Object's `contentType` field documentation](https://swagger.io/specification/#encoding-content-type), the empty schema for `items` indicates a media type of `application/octet-stream`.
...
| Field Name | Type | Description |
| --- | --- | --- |
| default | [Response Object](https://swagger.io/specification/#response-object) \| [Reference Object](https://swagger.io/specification/#reference-object) | The documentation of responses other than the ones declared for specific HTTP response codes. Use this field to cover undeclared responses. |
...
| Field Pattern | Type | Description |
| --- | --- | --- |
| {expression} | [Path Item Object](https://swagger.io/specification/#path-item-object) | A Path Item Object used to define a callback request and expected responses. A [complete example](https://learn.openapis.org/examples/v3.0/callback-example.html) is available. |

This object MAY be extended with [Specification Extensions](https://swagger.io/specification/#specification-extensions).

##### Key Expression

The key that identifies the [Path Item Object](https://swagger.io/specification/#path-item-object) is a [runtime expression](https://swagger.io/specification/#runtime-expressions) that can be evaluated in the context of a runtime HTTP request/response to identify the URL to be used for the callback request.
A simple example might be `$request.body#/url`.
However, using a [runtime expression](https://swagger.io/specification/#runtime-expressions) the complete HTTP message can be accessed.
...
The following example uses the user provided `queryUrl` query string parameter to define the callback URL. This is similar to a [webhook](https://swagger.io/specification/#oas-webhooks), but differs in that the callback only occurs because of the initial request that sent the `queryUrl`.
...
This object is typically used in fields named `examples` (plural), and is a [referenceable](https://swagger.io/specification/#reference-object) alternative to older `example` (singular) fields that do not support referencing or metadata.
...
Example Objects can be used in both [Parameter Objects](https://swagger.io/specification/#parameter-object) and [Media Type Objects](https://swagger.io/specification/#media-type-object).
In both Objects, this is done through the `examples` (plural) field.
However, there are several other ways to provide examples: The `example` (singular) field that is mutually exclusive with `examples` in both Objects, and two keywords (the deprecated singular `example` and the current plural `examples`, which takes an array of examples) in the [Schema Object](https://swagger.io/specification/#schema-object) that appears in the `schema` field of both Objects.
...
The exact serialization and encoding is determined by various fields in the Parameter Object, or in the Media Type Object's [Encoding Object](https://swagger.io/specification/#encoding-object).
...
| requestBody | Any \| [{expression}](https://swagger.io/specification/#runtime-expressions) | A literal value or [{expression}](https://swagger.io/specification/#runtime-expressions) to use as a request body when calling the target operation. |
...
However, because use of an operation depends on its URL path template in the [Paths Object](https://swagger.io/specification/#paths-object), operations from any [Path Item Object](https://swagger.io/specification/#path-item-object) that is referenced multiple times within the OAD cannot be resolved unambiguously.
...
field in an [Operation Object](https://swagger.io/specification/#operation-object)), references MAY also be made through a relative `operationRef`:
...
This mechanism is used by [Link Objects](https://swagger.io/specification/#link-object) and [Callback Objects](https://swagger.io/specification/#callback-object).
...
Describes a single header for [HTTP responses](https://swagger.io/specification/#response-headers) and for [individual parts in `multipart` representations](https://swagger.io/specification/#encoding-headers); see the relevant [Response Object](https://swagger.io/specification/#response-object) and [Encoding Object](https://swagger.io/specification/#encoding-object) documentation for restrictions on which headers can be described.

The Header Object follows the structure of the [Parameter Object](https://swagger.io/specification/#parameter-object), including determining its serialization strategy based on whether `schema` or `content` is present, with the following changes:

1. `name` MUST NOT be specified, it is given in the corresponding `headers` map.
2. `in` MUST NOT be specified, it is implicitly in `header`.
3. All traits that are affected by the location MUST be applicable to a location of `header` (for example, [`style`](https://swagger.io/specification/#parameter-style)). This means that `allowEmptyValue` and `allowReserved` MUST NOT be used, and `style`, if used, MUST be limited to `"simple"`.
...
For simpler scenarios, a [`schema`](https://swagger.io/specification/#header-schema) and [`style`](https://swagger.io/specification/#header-style) can describe the structure and syntax of the header.
...
Serializing with `schema` is NOT RECOMMENDED for headers with parameters (name=value pairs following a `;`) in their values, or where values might have non-URL-safe characters; see [Appendix D](https://swagger.io/specification/#appendix-d-serializing-headers-and-cookies) for details.
...
For more complex scenarios, the [`content`](https://swagger.io/specification/#header-content) field can define the media type and schema of the header, as well as give examples of its use.
...
Adds metadata to a single tag that is used by the [Operation Object](https://swagger.io/specification/#operation-object).
...
See the rules for resolving [Relative References](https://swagger.io/specification/#relative-references-in-api-description-uris).
...
| Field Name | Type | Description |
| --- | --- | --- |
| discriminator | [Discriminator Object](https://swagger.io/specification/#discriminator-object) | Adds support for polymorphism. The discriminator is used to determine which of a set of schemas a payload is expected to satisfy. See [Composition and Inheritance](https://swagger.io/specification/#composition-and-inheritance-polymorphism) for more details. |
| xml | [XML Object](https://swagger.io/specification/#xml-object) | This MAY be used only on property schemas. It has no effect on root schemas. Adds additional metadata to describe the XML representation of this property. |
...
To support polymorphism, the OpenAPI Specification adds the [`discriminator`](https://swagger.io/specification/#schema-discriminator) field.
...
- Use the schema name.
- [Override the schema name](https://swagger.io/specification/#discriminator-mapping) by overriding the property with a new value. If a new value exists, this takes precedence over the schema name.
...
The [xml](https://swagger.io/specification/#schema-xml) field allows extra definitions when translating the JSON definition to XML.
The [XML Object](https://swagger.io/specification/#xml-object) contains additional information about the available options.
...
To allow use of a different default `$schema` value for all Schema Objects contained within an OAS document, a `jsonSchemaDialect` value may be set within the [OpenAPI Object](https://swagger.io/specification/#openapi-object). If this default is not set, then the OAS dialect schema id MUST be used for these Schema Objects. The value of `$schema` within a resource root Schema Object always overrides any default.

For standalone JSON Schema documents that do not set `$schema`, or for Schema Objects in OpenAPI description documents that are _not_ [complete documents](https://swagger.io/specification/#openapi-description-structure), the dialect SHOULD be assumed to be the OAS dialect.
...
The value of the property named in `propertyName` is used as the name of the associated schema under the [Components Object](https://swagger.io/specification/#components-object), _unless_ a `mapping` is present for that value.
...
For these examples, assume all schemas are in the [entry document](https://swagger.io/specification/#openapi-description-structure) of the OAD; for handling of `discriminator` in referenced documents see [Resolving Implicit Connections](https://swagger.io/specification/#resolving-implicit-connections).
...
The `namespace` field is intended to match the syntax of [XML namespaces](https://www.w3.org/-t-r/xml-names11/), although there are a few caveats:
...
Each of the following examples represent the value of the `properties` keyword in a [Schema Object](https://swagger.io/specification/#schema-object) that is omitted for brevity.
...
| openIdConnectUrl | `string` | `openIdConnect` | **REQUIRED**. [Well-known URL](https://openid.net/specs/openid-connect-discovery-1_0.html#-provider-config) to discover the \[\[OpenID-Connect-Discovery\]\] [provider metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#-provider-metadata). |
...
The name used for each property MUST correspond to a security scheme declared in the [Security Schemes](https://swagger.io/specification/#security-scheme-object) under the [Components Object](https://swagger.io/specification/#components-object).
...
[Schema Objects](https://swagger.io/specification/#schema-object) validate data based on the [JSON Schema data model](https://datatracker.ietf.org/doc/html/draft-bhutton-json-schema-00#section-4.2.1), which only recognizes four primitive data types: strings (which are [only broadly interoperable as UTF-8](https://datatracker.ietf.org/doc/html/rfc7159#section-8.1)), numbers, booleans, and `null`.
...
The [Parameter Object](https://swagger.io/specification/#parameter-object), [Header Object](https://swagger.io/specification/#header-object), and [Encoding Object](https://swagger.io/specification/#encoding-object) offer features to control how to arrange values from array or object types.
...
| Object | Condition |
| --- | --- |
| [Parameter Object](https://swagger.io/specification/#parameter-object) | When `schema` is present |
| [Header Object](https://swagger.io/specification/#header-object) | When `schema` is present |
| [Encoding Object](https://swagger.io/specification/#encoding-object) | When encoding for `application/x-www-form-urlencoded` and any of `style`, `explode`, or `allowReserved` are used |
...
See [Appendix E](https://swagger.io/specification/#appendix-e-percent-encoding-and-form-media-types) for additional guidance on handling delimiters for `style` values with no RFC6570 equivalent that already need to be percent-encoded when used as delimiters.
...
See also [Appendix E](https://swagger.io/specification/#appendix-e-percent-encoding-and-form-media-types) for further guidance on percent-encoding and form media types, including guidance on handling the delimiter characters for `spaceDelimited`, `pipeDelimited`, and `deepObject` in parameter names and values.
...
This style is specified to be equivalent to RFC6570 form expansion which includes the `?` character (see [Appendix C](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization) for more details), which is not part of the cookie syntax.
...
This means that while these three characters are reserved-but-allowed in query strings by RFC3986, they must be percent-encoded in `form-urlencoded` query strings except when used for their `form-urlencoded` purposes; see [Appendix C](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization) for an example of handling `+` in form values.
...
| [RFC1866](https://datatracker.ietf.org/doc/html/rfc1866#section-8.2.1) | 11/1995 | content-based serialization | \[\[RFC1738\]\] | obsoleted by \[\[HTML401\]\] [Section 17.13.4.1](https://www.w3.org/-t-r/html401/interact/forms.html#h-17.13.4.1), \[\[URL\]\] [Section 5](https://url.spec.whatwg.org/#urlencoded-serializing) |

Style-based serialization is used in the [Parameter Object](https://swagger.io/specification/#parameter-object) when `schema` is present, and in the [Encoding Object](https://swagger.io/specification/#encoding-object) when at least one of `style`, `explode`, or `allowReserved` is present.
See [Appendix C](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization) for more details of RFC6570's two different approaches to percent-encoding, including an example involving `+`.

Content-based serialization is defined by the [Media Type Object](https://swagger.io/specification/#media-type-object), and used with the [Parameter Object](https://swagger.io/specification/#parameter-object) when the `content` field is present, and with the [Encoding Object](https://swagger.io/specification/#encoding-object) based on the `contentType` field when the fields `style`, `explode`, and `allowReserved` are absent.
...
This appendix shows how to retrieve an HTTP-accessible multi-document OpenAPI Description (OAD) and resolve a [Security Requirement Object](https://swagger.io/specification/#security-requirement-object) in the referenced (non-entry) document. See [Resolving Implicit Connections](https://swagger.io/specification/#resolving-implicit-connections) for more information.

First, the [entry document](https://swagger.io/specification/#openapi-description-structure) is where parsing begins. It defines the `MySecurity` security scheme to be JWT-based, and it defines a Path Item as a reference to a component in another document:
...
In the `other` document, the referenced path item has a Security Requirement for a Security Scheme, `MySecurity`. The same Security Scheme exists in the original entry document. As outlined in [Resolving Implicit Connections](https://swagger.io/specification/#resolving-implicit-connections), `MySecurity` is resolved with an [implementation-defined behavior](https://swagger.io/specification/#undefined-and-implementation-defined-behavior). However, documented in that section, it is RECOMMENDED that tools resolve component names from the [entry document](https://swagger.io/specification/#openapi-description-structure). As with all implementation-defined behavior, it is important to check tool documentation to determine which behavior is supported.

01. [Version 3.1.1](https://swagger.io/specification/#version-3.1.1)
02. [Introduction](https://swagger.io/specification/#introduction)
03. [Definitions](https://swagger.io/specification/#definitions)
    1. [OpenAPI Description](https://swagger.io/specification/#openapi-description)
    2. [OpenAPI Document](https://swagger.io/specification/#openapi-document)
    3. [Schema](https://swagger.io/specification/#schema)
    4. [Object](https://swagger.io/specification/#object)
    5. [Path Templating](https://swagger.io/specification/#path-templating)
    6. [Media Types](https://swagger.io/specification/#media-types)
    7. [HTTP Status Codes](https://swagger.io/specification/#http-status-codes)
    8. [Case Sensitivity](https://swagger.io/specification/#case-sensitivity)
    9. [Undefined and Implementation-Defined Behavior](https://swagger.io/specification/#undefined-and-implementation-defined-behavior)
04. [Specification](https://swagger.io/specification/#specification)
    01. [Versions](https://swagger.io/specification/#versions)
    02. [Format](https://swagger.io/specification/#format)
    03. [OpenAPI Description Structure](https://swagger.io/specification/#openapi-description-structure)
        1. [Parsing Documents](https://swagger.io/specification/#parsing-documents)
        2. [Structural Interoperability](https://swagger.io/specification/#structural-interoperability)
        3. [Resolving Implicit Connections](https://swagger.io/specification/#resolving-implicit-connections)
    04. [Data Types](https://swagger.io/specification/#data-types)
        1. [Data Type Format](https://swagger.io/specification/#data-type-format)
        2. [Working with Binary Data](https://swagger.io/specification/#working-with-binary-data)
    05. [Rich Text Formatting](https://swagger.io/specification/#rich-text-formatting)
    06. [Relative References in API Description URIs](https://swagger.io/specification/#relative-references-in-api-description-uris)
    07. [Relative References in API URLs](https://swagger.io/specification/#relative-references-in-api-urls)
    08. [Schema](https://swagger.io/specification/#schema-1)
        01. [OpenAPI Object](https://swagger.io/specification/#openapi-object)
        02. [Info Object](https://swagger.io/specification/#info-object)
        03. [Contact Object](https://swagger.io/specification/#contact-object)
        04. [License Object](https://swagger.io/specification/#license-object)
        05. [Server Object](https://swagger.io/specification/#server-object)
        06. [Server Variable Object](https://swagger.io/specification/#server-variable-object)
        07. [Components Object](https://swagger.io/specification/#components-object)
        08. [Paths Object](https://swagger.io/specification/#paths-object)
        09. [Path Item Object](https://swagger.io/specification/#path-item-object)
    ...
    09. [Specification Extensions](https://swagger.io/specification/#specification-extensions)
    10. [Security Filtering](https://swagger.io/specification/#security-filtering)
05. [Security Considerations](https://swagger.io/specification/#security-considerations)
    1. [OpenAPI Description Formats](https://swagger.io/specification/#openapi-description-formats)
    2. [Tooling and Usage Scenarios](https://swagger.io/specification/#tooling-and-usage-scenarios)
    3. [Security Schemes](https://swagger.io/specification/#security-schemes)
    4. [Handling External Resources](https://swagger.io/specification/#handling-external-resources)
    5. [Handling Reference Cycles](https://swagger.io/specification/#handling-reference-cycles)
    6. [Markdown and HTML Sanitization](https://swagger.io/specification/#markdown-and-html-sanitization)
06. [Appendix A: Revision History](https://swagger.io/specification/#appendix-a-revision-history)
07. [Appendix B: Data Type Conversion](https://swagger.io/specification/#appendix-b-data-type-conversion)
08. [Appendix C: Using RFC6570-Based Serialization](https://swagger.io/specification/#appendix-c-using-rfc6570-based-serialization)
    1. [Equivalences Between Fields and RFC6570 Operators](https://swagger.io/specification/#equivalences-between-fields-and-rfc6570-operators)
    2. [Delimiters in Parameter Values](https://swagger.io/specification/#delimiters-in-parameter-values)
    3. [Non-RFC6570 Field Values and Combinations](https://swagger.io/specification/#non-rfc6570-field-values-and-combinations)
    4. [Examples](https://swagger.io/specification/#examples-3)
       1. [RFC6570-Equivalent Expansion](https://swagger.io/specification/#rfc6570-equivalent-expansion)
       2. [Expansion with Non-RFC6570-Supported Options](https://swagger.io/specification/#expansion-with-non-rfc6570-supported-options)
       3. [Undefined Values and Manual URI Template Construction](https://swagger.io/specification/#undefined-values-and-manual-uri-template-construction)
       4. [Illegal Variable Names as Parameter Names](https://swagger.io/specification/#illegal-variable-names-as-parameter-names)
09. [Appendix D: Serializing Headers and Cookies](https://swagger.io/specification/#appendix-d-serializing-headers-and-cookies)
10. [Appendix E: Percent-Encoding and Form Media Types](https://swagger.io/specification/#appendix-e-percent-encoding-and-form-media-types)
    1. [Percent-Encoding and form-urlencoded](https://swagger.io/specification/#percent-encoding-and-form-urlencoded)
    2. [Percent-Encoding and form-data](https://swagger.io/specification/#percent-encoding-and-form-data)
    3. [Generating and Validating URIs and form-urlencoded Strings](https://swagger.io/specification/#generating-and-validating-uris-and-form-urlencoded-strings)
       1. [Interoperability with Historical Specifications](https://swagger.io/specification/#interoperability-with-historical-specifications)
       2. [Interoperability with Web Browser Environments](https://swagger.io/specification/#interoperability-with-web-browser-environments)
    4. [Decoding URIs and form-urlencoded Strings](https://swagger.io/specification/#decoding-uris-and-form-urlencoded-strings)
    5. [Percent-Encoding and Illegal or Reserved Delimiters](https://swagger.io/specification/#percent-encoding-and-illegal-or-reserved-delimiters)
11. [Appendix F: Resolving Security Requirements in a Referenced Document](https://swagger.io/specification/#appendix-f-resolving-security-requirements-in-a-referenced-document)
